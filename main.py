...
# Replace the GPT-2 loading code with:
try:
    # Phi-2 requires these specific parameters
    ...
    print("Successfully loaded Phi-2 model")  # Update message
except Exception as e:
...
if json_data and model:
    chatbot_service = ChatbotService(model, tokenizer, json_data)  # Pass model, tokenizer, and json_data
